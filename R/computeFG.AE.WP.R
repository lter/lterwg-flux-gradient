...
#' 
computeFG.AE.WP <- function(min9.K, eddy.diff.name = "EddyDiff"){
  ...
  H2O.FG <- FG_AE.WP(min9 = H2O, eddy.diff.name = eddy.diff.name)
  ...
  CO2.FG <- FG_AE.WP(min9 = CO2, eddy.diff.name = eddy.diff.name)
  ...
  CH4.FG <- FG_AE.WP(min9 = CH4, eddy.diff.name = eddy.diff.name)
