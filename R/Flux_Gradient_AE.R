...
Flux_Gradient_AE <- function(cont.df, attr.df, z1_height, z2_height, z_height){
  ...
  #FG AE calculation: unit conversion constant for molar to mass mixing ratio for ch4 is conversion from umol to mol then multiply by ratio of dry air g/mol (28.96) and ch4 g/mol (16.04), calculting air density using air pressure converts from kPan to Pa, air temp converted to Kelvin, and gas constant for dry air (287.058 J/kgK)
  ae.df[,which(names(ae.df) == F_ch4_AE)] <- ((1/1000000)*(28.96/16.04))*((as.numeric(cont.df$airpress)*1000)/(287.058*(as.numeric(cont.df$airtemp)+273.15)))*(as.numeric(ae.K))*(Conc_CH4_z1-Conc_CH4_z2/z1-z2)
  ...
  ae.df[,which(names(ae.df) == F_co2_AE)] <- ((1/1000000)*(28.96/44.01))*((as.numeric(cont.df$airpress)*1000)/(287.058*(as.numeric(cont.df$airtemp)+273.15)))*(as.numeric(ae.K))*(Conc_co2_z1-Conc_co2_z2/z1-z2)
  ...
  ae.df[,which(names(ae.df) == F_LE_AE)] <- ((1/1000)*(28.96/18.02))*((as.numeric(cont.df$airpress)*1000)/(287.058*(as.numeric(cont.df$airtemp)+273.15)))*(as.numeric(ae.K))*(Conc_h2o_z1-Conc_h2o_z2/z1-z2)
  ...
  ae.df[,which(names(ae.df) == F_ch4_AE_WP)] <- ((1/1000000)*(28.96/16.04))*((as.numeric(cont.df$airpress)*1000)/(287.058*(as.numeric(cont.df$airtemp)+273.15)))*(as.numeric(wp.K))*(Conc_CH4_z1-Conc_CH4_z2/z1-z2)
  ...
  ae.df[,which(names(ae.df) == F_co2_AE_WP)] <- ((1/1000000)*(28.96/44.01))*((as.numeric(cont.df$airpress)*1000)/(287.058*(as.numeric(cont.df$airtemp)+273.15)))*(as.numeric(wp.K))*(Conc_co2_z1-Conc_co2_z2/z1-z2)
  ...
  ae.df[,which(names(ae.df) == F_LE_AE_WP)] <- ((1/1000)*(28.96/18.02))*((as.numeric(cont.df$airpress)*1000)/(287.058*(as.numeric(cont.df$airtemp)+273.15)))*(as.numeric(wp.K))*(Conc_h2o_z1-Conc_h2o_z2/z1-z2)
