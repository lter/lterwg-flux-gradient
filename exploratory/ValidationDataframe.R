...
for( site in site.list){
  ...
  rm( WP_9min.df ,min9.FG.WP.list,WP_30min.df,min30.FG.WP.list,
      AE_9min.df, min9.FG.AE.list, AE_30min.df,min30.FG.AE.list,
      MBR_9min.df, MBRflux_align, MBR_30min.df, MBRflux_align_30min)
}
