...
#local load files
sitecode <- 'TOOL'
load(file.path("data", sitecode, paste0(sitecode,"_WP_AH_2024-03-13.Rdata")))
...
#upload to g drive
#googledrive::drive_upload(media = paste0("data/Validation/SITES_MBR.Rdata"), overwrite = T, path = drive_url)
# googledrive::drive_upload(media = paste0("data/Validation/SITES_AE.zip"), overwrite = T, path = drive_url)
googledrive::drive_upload(media = paste0("data/Validation/SITES_WP.Rdata"), overwrite = T, path = drive_url)
