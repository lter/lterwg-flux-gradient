...
Flux_Gradient_MBR <- function(cont.df, attr.df, z1_height, z2_height){
  ...
  #calculate ch4 flux and add to df: need to include unit conversion for h2O to get from W/m^2 to mmmol using latent heat of vaporization (2.26e3 J/g) and molar mass (18.02 g/mol)
  ...
  #MBR co2 flux using latent heat: need to include unit conversion for h2O to get from W/m^2 to mmmol using latent heat of vaporization (2.26e3 J/g) and molar mass (18.02 g/mol)
