...
source(file.path(gh_repo, "functions", "calc.eddydiff.windprof.R"))
...
min9.K.WP.list <- calc.eddydiff.windprof(sitecode = site, min9 = min9Diff.list)
#min30.K.WP.list <- calc.eddydiff.windprof(sitecode = site, min9 = min30Diff.list)
