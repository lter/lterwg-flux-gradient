...
for (site in site.list){
  ...
  if (save_temp == 0){
    ...
    fileSave <- fs::path(aligned_conc_dir, site, paste0(site, '_aligned_conc_flux_9min.RData'))
    fileZip <- fs::path(aligned_conc_dir, site, paste0(site, '_aligned_conc_flux_9min.zip'))
